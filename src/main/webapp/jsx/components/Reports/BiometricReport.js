    ...
    const handleSubmit = (e) => {
        ...
        axios
            ...
            .then((response) => {
                ...
                const fileName =
                    `${objValues.organisationUnitName}_BIOMETRIC_REPORT_${objValues.startDate}_${objValues.endDate}.xlsx`;

                FileSaver.saveAs(blob, fileName);

                toast.success(
                    "Biometric Report generated successfully"
                );
            })
            .catch((error) => {
                setLoading(false);
            ...
            <CardBody>
                <Box mb={3}>
                    ...
                    <Typography
                        ...
                        style={{ marginTop: 5 }}
                    >
                        Generate biometric performance reports using a
                        selected facility and reporting period.
                    </Typography>
                </Box>
                            ...
                            <Autocomplete
                                ...
                                renderInput={(params) => (
                                    <TextField
                                        ...
                                        helperText="Select a facility to generate the report"
                                    />
                                )}
                            />
                        </div>

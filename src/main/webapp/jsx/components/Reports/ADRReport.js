...
const ADRReport = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post(
                `${baseUrl}adr-reporting?facilityId=${objValues.organisationUnitId}&startDate=${objValues.startDate}&endDate=${objValues.endDate}`,
            ...
            .then((response) => {
                ...
                const fileName = `${objValues.organisationUnitName}_ADR_${currentDate}.xlsx`;

                FileSaver.saveAs(blob, fileName);

                toast.success(
                    "ADR Report generated successfully"
                );
            })
            .catch((error) => {
                setLoading(false);
            ...
            <CardBody>
                ...
                <Box mb={3}>
                    ...
                    <Typography
                        ...
                        color="textSecondary"
                    >
                        Generate Adverse Drug Reaction (ADR)

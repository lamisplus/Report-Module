...
const LaboratoryReport = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .get(
                `${baseUrl}reporting/laboratory/${objValues.organisationUnitId}`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`
                    },
            ...
            .then((response) => {
                ...
                const fileName = `${objValues.organisationUnitName}_LABORATORY_${currentDate}.xlsx`;

                FileSaver.saveAs(blob, fileName);

                toast.success(
                    "Laboratory Report generated successfully"
                );
            })
            .catch((error) => {
                setLoading(false);
            ...
            <CardBody>
                ...
                <Box mb={3}>
                    ...
                    <Typography
                        ...
                        color="textSecondary"
                    >
                        Generate laboratory reports for a selected
                        facility and export the results to Excel.
                    </Typography>
                </Box>

...
const HTSReport = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post(
                `${baseUrl}hts-reporting?facilityId=${objValues.organisationUnitId}&startDate=${objValues.startDate}&endDate=${objValues.endDate}&reportType=${objValues.reportType}&scramber=${objValues.scrambler}`,
            ...
            .then((response) => {
                ...
                const fileName = `${objValues.organisationUnitName}_HTS_${reportName}_${objValues.startDate}_${objValues.endDate}.xlsx`;

                FileSaver.saveAs(blob, fileName);

                toast.success(
                    "HTS Report generated successfully"
                );
            })
            .catch((error) => {
                setLoading(false);
            ...
            <CardBody>
                <Box mb={3}>
                    ...
                    <Typography
                        ...
                        color="textSecondary"
                    >
                        Generate HTS reports using a selected date range,
                        facility and reporting type.
                    </Typography>
                </Box>

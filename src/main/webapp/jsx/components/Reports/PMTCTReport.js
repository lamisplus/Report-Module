...
const PMTCTReport = (props) => {
    ...
    const handleSubmit = (e) => {      
        e.preventDefault();
        setLoading(true)
        axios.get(`${baseUrl}reporting/ptmct?facilityId=${objValues.organisationUnitId}&startDate=${objValues.startDate}&endDate=${objValues.endDate}`,
           { headers: {"Authorization" : `Bearer ${token}`}, responseType: 'blob'},
          
          )
              .then(response => {
                setLoading(false)
                const fileName = `${objValues.organisationUnitName} PMTCT-Report ${currentDate}`
                        ...
                        <div className="form-group  col-md-6">
                            ...
                            {loading && (
                                ...
                                <Message.Header>Please wait...</Message.Header>
                                    PMTCT report is been generated
                                </Message.Content>
                                </Message>
                            )}
                        </div>

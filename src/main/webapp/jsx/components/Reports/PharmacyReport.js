...
const PharmacyReport = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .get(
                `${baseUrl}reporting/pharmacy/${objValues.organisationUnitId}`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`
                    },
            ...
            .then((response) => {
                ...
                const fileName = `${objValues.organisationUnitName}_PHARMACY_${currentDate}.xlsx`;

                FileSaver.saveAs(blob, fileName);

                toast.success(
                    "Pharmacy Report generated successfully"
                );
            })
            .catch((error) => {
                setLoading(false);
            ...
            <CardBody>
                ...
                <Box mb={3}>
                    ...
                    <Typography
                        ...
                        color="textSecondary"
                    >
                        Generate pharmacy reports for a selected
                        facility and export results to Excel.
                    </Typography>
                </Box>

    ...
    const handleSubmit = (e) => {
        ...
        axios
            ...
            .then((response) => {
                ...
                const fileName = `${objValues.organisationUnitName}_NCD_REPORT_${currentDate}.xlsx`;

                FileSaver.saveAs(blob, fileName);

                toast.success(
                    "NCD Report generated successfully"
                );
            })
            .catch((error) => {
                setLoading(false);
            ...
            <CardBody>
                ...
                <Box mb={3}>
                    ...
                    <Typography
                        ...
                        color="textSecondary"
                    >
                        Generate Non-Communicable Disease (NCD)
                        reports using a selected date range and
                        facility.
                    </Typography>
                </Box>

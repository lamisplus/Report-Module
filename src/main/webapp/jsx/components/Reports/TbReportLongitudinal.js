  ...
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        const fileName = `${objValues.organisationUnitName}_TB_LONGITUDINAL_${currentDate}.xlsx`;

        FileSaver.saveAs(blob, fileName);

        toast.success(
          "TB Longitudinal Report generated successfully"
        );
      })
      .catch((error) => {
        setLoading(false);
      ...
      <CardBody>
        ...
        <Box mb={3}>
          ...
          <Typography
            ...
            color="textSecondary"
          >
            Generate TB longitudinal reports using a
            selected date range and facility.
          </Typography>
        </Box>
...
export default TbReportLongitudinal;
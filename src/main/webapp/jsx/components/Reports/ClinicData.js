...
const ClinicData = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .get(
                `${baseUrl}reporting/clinic-data/${objValues.organisationUnitId}`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`
                    },
            ...
            .then((response) => {
                ...
                const fileName = `${objValues.organisationUnitName}_CLINIC_DATA_${currentDate}.xlsx`;

                FileSaver.saveAs(blob, fileName);

                toast.success(
                    "Clinic Data Report generated successfully"
                );
            })
            .catch((error) => {
                setLoading(false);
            ...
            <CardBody>
                ...
                <Box mb={3}>
                    ...
                    <Typography
                        ...
                        color="textSecondary"
                    >
                        Generate clinic data reports for a selected
                        facility and export the report to Excel.
                    </Typography>
                </Box>

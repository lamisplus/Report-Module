...
const PrepLongitudinalReport = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post(
                `${baseUrl}longitudinal-prep?facilityId=${objValues.organisationUnitId}&startDate=${objValues.startDate}&endDate=${objValues.endDate}`,
            ...
            .then((response) => {
                ...
                const fileName = `${objValues.organisationUnitName}_PREP_LONGITUDINAL_REPORT_${objValues.startDate}_${objValues.endDate}.xlsx`;

                FileSaver.saveAs(blob, fileName);

                toast.success(
                    "PrEP Longitudinal Report generated successfully"
                );
            })
            .catch((error) => {
                setLoading(false);
            ...
            <CardBody>
                <Box mb={3}>
                    ...
                    <Typography
                        ...
                        style={{ marginTop: 5 }}
                    >
                        Generate longitudinal PrEP reports using a selected
...
export default PrepLongitudinalReport;
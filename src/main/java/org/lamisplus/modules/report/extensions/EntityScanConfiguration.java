package org.lamisplus.modules.report.extensions;
...
import org.lamisplus.modules.report.domain.ReportDomain;
...
public class EntityScanConfiguration implements HibernatePackageConfigurer {
    ...
    public void configureHibernatePackage(HibernatePackageRegistry hibernatePackage) {
        hibernatePackage.addPackageToScan (ReportDomain.class, HIVDomain.class, PatientDomain.class, TriageDomain.class);
    }
}

...
//            "         (WITH oldTbQuery AS (\n" +
//            "SELECT * FROM (SELECT\n" +
//            "     COALESCE(NULLIF(CAST(data->'tbIptScreening'->>'treatementType' AS text), ''), '') as tbTreatementTypeOld,\n" +
//            "     NULLIF(CAST(NULLIF(data->'tbIptScreening'->>'tbTreatmentStartDate', '') AS DATE), NULL)as tbTreatmentStartDateOld,\n" +
...
//            "    AND tbTreatmentStartDateOld IS NOT NULL\n" +
//            "\t),\n" +
//            "tbTreatmentNew AS (\n" +
//            "WITH tb_start AS (\n" +
...
//            "        NULLIF(CAST(NULLIF(data->'tbIptScreening'->>'tbTreatmentStartDate' , '') AS DATE), NULL) AS tbTreatmentStartDateNew,\n" +
...
//            "\t    data->'tbIptScreening'->>'tbType' AS tbTreatmentTypeNew,\n" +
...
//            "),\n" +
//            "\n" +
//            "-- Query for tb_completion\n" +
//            "tb_completion AS (\n" +
//            "    SELECT\n" +
//            "        person_uuid AS person_uuid,  -- Use person_uuid to uniquely identify each record\n" +
//            "        NULLIF(CAST(NULLIF(data->'tbIptScreening'->>'completionDate', '') AS DATE), NULL) AS completionDateNew,\n" +
...
//            ") \n" +
//            "SELECT \n" +
//            "  COALESCE(tbTreatmentNew.person_uuid_tb, oldTbQuery.tbTreatmentPersonUuid ) AS tbTreatmentPersonUuid,\n" +
//            "  COALESCE(tbTreatmentNew.tbTreatmentStartDateNew, oldTbQuery.tbTreatmentStartDateOld) AS tbTreatmentStartDate,\n" +
//            "  COALESCE(tbTreatmentNew.tbTreatmentTypeNew, oldTbQuery.tbTreatementTypeOld) AS tbTreatementType,\n" +
//            "  COALESCE(tbTreatmentNew.treatmentOutcome , oldTbQuery.tbTreatmentOutcome ) AS tbTreatmentOutcome,\n" +
//            "  COALESCE(tbTreatmentNew.completionDateNew, oldTbQuery.tbCompletionDate) AS tbCompletionDate\t\n" +
//            "FROM\n" +
//            "  oldTbQuery\n" +
//            "  LEFT JOIN tbTreatmentNew ON oldTbQuery.tbTreatmentPersonUuid = tbTreatmentNew.person_uuid_tb\n" +
//            "ORDER BY\n" +
//            "  tbTreatmentNew.screeningDate DESC;),\n" +
//            "\n" +

...
public class PMTCTReportQuery {
    ...
    public static final String PMTCT_REPORT = "WITH pmtctHts AS (\n" +
            ...
            "CASE WHEN hc.hepatitis_testing->>'hepatitisBTestResult' IN ('Yes', 'No')  THE hc.date_visit ELSE NULL END AS hepatitisBTestDate, \n" +
            ...
            "CASE WHEN hc.hepatitis_testing->>'hepatitisCTestResult' IN ('Yes', 'No')  THE hc.date_visit ELSE NULL END AS hepatitisCTestDate, \n" +
